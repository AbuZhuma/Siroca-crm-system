...
interface IAddManager {
    forWhat: "createSubtask" | "editSubtask" | "editAdd" | "createCompany" | "changeCompany";
    oneSubtask?: ISubtask;
...
export const AddManager: FC<IAddManager> = (props) => {
    ...
    const { addManagerToPutSubtask } = putSubtaskApi();
    ...
    const postTrim = () => {
        if (managerExists === true) {
            if (forWhat === "createSubtask") {
                ...
                addManagerToPutSubtask(managerInputState);
            } else if (forWhat === "editAdd" && oneSubtask) {
